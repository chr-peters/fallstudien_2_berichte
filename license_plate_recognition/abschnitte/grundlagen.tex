...
angepasst werden. Dieses Vorgehen wird in
...
von neuronalen Netzen zum Einsatz.
...
Convolutional Neural Networks (im Folgenden CNN) zeichnen sich dadurch aus,
dass in mindestens einer Schicht keine klassische Matrix-Vektor
Multiplikation durchgef\"uhrt wird, sondern eine sogenannte
Faltungsoperation (eng. Convolution).
